...
- ⬜ **Resteert voor "Dossier voorbereiden":** bewijs-PDF via Playwright (headless browser, onbewezen op Railway), en de **VABI-berekening** zelf — die blijft bewust handwerk bij Kevin op zijn eigen machine (de cloud zet alleen het dossier klaar). OneNote-aanmaak is er, maar pas actief als Kevin de notitieboek/sectie/sjabloon-velden invult.
...
- **F3 "Dossier voorbereiden" — stand van de onderdelen:** ✅ VABI-sjabloon invullen (op de core-templates, geen berekening — cloud zet klaar, Kevin rekent in VABI), ✅ OneDrive-dossier (map + .epa + Invoerkaart.txt), ✅ To Do, ✅ optioneel OneNote (PR #14). ⬜ Resteert: **bewijs-PDF** (Playwright, onbewezen op Railway — zelfde risico als Upload).
