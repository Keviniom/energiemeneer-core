...
- ⬜ **Resteert voor "Dossier voorbereiden":** de **VABI-berekening** zelf blijft bewust handwerk bij Kevin (de cloud zet alleen het dossier klaar); OneNote-aanmaak staat klaar maar pas actief als Kevin de notitieboek/sectie/sjabloon-velden invult; en het **dashboard** (overzicht openstaande adressen + handmatige knop) is de volgende fase — de basis (events + handmatige trigger) ligt er.
